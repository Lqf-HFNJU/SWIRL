...
MODEL_PATH=/path/to/base/teacher
MODEL_SAVE_PATH=/path/to/save/teacher
TRAINER_NAME=round_x

TRAIN_FILE=$PROJECT_DIR/data/SWIRL_MATH_data/train/MATH_train.parquet
...
grounding_agent_config="${5:-$grounding_agent_config}"
...
python3 -m verl.trainer.main_ppo \
    ...
    reward_model.reward_manager=teacher \
